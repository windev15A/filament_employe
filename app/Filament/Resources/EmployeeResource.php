            ...
            ->schema([
                Card::make()
                    ->schema([
                        ...
                        DatePicker::make('birth_date')->required()->required(),
                        DatePicker::make('date_hired')->required()->required(),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                TextColumn::make('first_name')->label('Nom')->sortable()->searchable(),
                TextColumn::make('last_name')->label('Prénom')->sortable()->searchable(),
